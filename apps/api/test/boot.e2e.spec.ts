...
const EXPECTED_ROUTES = [
  ...
  "GET /api/v1/guests/discovery-status",
  "POST /api/v1/guests/discover",
  "GET /api/v1/guests/suggestions",
  "POST /api/v1/guests/suggestions/:id/promote",
  "POST /api/v1/guests",
  ...
  "POST /api/v1/calendar/plan",
  "PATCH /api/v1/calendar/:id",
  "POST /api/v1/calendar/:id/run",
